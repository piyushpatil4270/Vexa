...
const Profile = ({createTask,setCreateTask}) => {
  ...
  return (
    <div className='h-full w-full relative flex flex-col items-center'>
      ...
      {user?(<div className='mt-[20px] md:ml-[20px] rounded-[20px] md:w-[70%] xs:w-[90%] xs:h-[100px] sm:h-[150px] bg-black h-[150px]   items-center'>
      <div className='w-full h-full flex  justify-start items-center'>
        <div className='ml-[10px] h-full w-[40%] flex justify-center items-center'>
        <img src={Profilepic} className='xs:w-[60px] h-[60px] sm:w-[100px] sm:h-[100px] rounded-full object-cover'  />
        </div>
        <div className='w-[40%] flex flex-col xs:gap-[4px]  sm:gap-[8px]'>
         <span className='text-white xs:text-[16px] sm:text-[18px]'>{user.username}</span>
         ...
         <div className='flex gap-[15px]'>
          <div className='w-fit  py-1 px-1 bg-[#1f732e74] flex items-center justify-center rounded-[5px]'>
            <span className='text-[#40dc45] xs:text-[12px] sm:text-[14px] '>{user.role}</span>
          </div>
          <div className='w-fit py-1 px-1 bg-[#6523947a] flex items-center justify-center rounded-[5px]'>
          <span className=' text-[#b455ef] xs:text-[12px] md:text-[14px] flex items-center justify-center'>active</span>
          </div>
